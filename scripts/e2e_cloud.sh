...
API_URL="${API_URL:-https://gryuohugoausgomeosdr.supabase.co}"
ANON_KEY="${ANON_KEY:-eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdyeXVvaHVnb2F1c2dvbWVvc2RyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NzY1MzY3MSwiZXhwIjoyMDkzMjI5NjcxfQ.rXtE721UKi_d5FxrSzS8seJpbIWDUZF9w29loMLiyYU}"
SUPERVISOR_EMAIL="${SUPERVISOR_EMAIL:-viagr@ciklum.com}"
SUPERVISOR_PASS="${SUPERVISOR_PASS:-LocalDev2026!}"
